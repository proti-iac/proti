 ...
 *
 * Originally generated using json-schema-to-typescript, which supports JSON schema draft-04.
 * Then manually refined to address the lacks and incompatibilities with JSON schema 2020-12.
 * Ideally, we find a typescript type generator that supports the recent JSON schema versions
 * Pulumi uses in the central package schema definition.
 */
...
export interface UnionType {
	 ...
	 */
	oneOf: [TypeReference, TypeReference, ...TypeReference[]];
	/**
